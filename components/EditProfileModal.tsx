                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="ĐH Khoa học Huế">ĐH Khoa học Huế</option>
                                    <option value="ĐH Kinh tế Huế">ĐH Kinh tế Huế</option>
                                    <option value="ĐH Sư phạm Huế">ĐH Sư phạm Huế</option>
                                    <option value="ĐH Ngoại ngữ Huế">ĐH Ngoại ngữ Huế</option>
                                    <option value="ĐH Y Dược Huế">ĐH Y Dược Huế</option>
                                    <option value="ĐH Nông lâm Huế">ĐH Nông lâm Huế</option>
                                    <option value="ĐH Nghệ thuật Huế">ĐH Nghệ thuật Huế</option>
                                    <option value="ĐH Luật Huế">ĐH Luật Huế</option>
                                </select>
                            </div>
                        </div>
