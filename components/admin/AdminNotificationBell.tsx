    ...
    useEffect(() => {
        ...
        const channel = supabase
            ...
            .on(
                ...
                (payload) => {
                    console.log('[AdminNotificationBell] New notification inserted:', payload);
                    debouncedFetch();
                }
            )
            .on(
                ...
                (payload) => {
                    console.log('[AdminNotificationBell] Notification updated:', payload);
                    debouncedFetch();
                }
            )
            .on(
                ...
                (payload) => {
                    console.log('[AdminNotificationBell] Notification deleted:', payload);
                    debouncedFetch();
                }
            )
            .subscribe((status) => {
